    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6" dir="rtl">
      ...
      >
        ...
        <div className="flex flex-wrap items-center gap-6">
          <div className="flex items-center gap-2" style={{ color: '#B0B0B0' }}>
            <Calendar size={16} />
            <span className="text-sm">{post.date}</span>
          </div>
          <div className="flex items-center gap-2">
            <Tag size={16} style={{ color: '#B0B0B0' }} />
            ...
            <ReactMarkdown
              components={{
                code({ className, children, ...props }) {
                  ...
                  return (
                    <div className="my-4 rounded-lg overflow-hidden" style={{ border: '1px solid #1C39BB40' }}>
                      {match && (
                        <div
                ...
                h3({ children }) {
                  return (
                    <h3
                      className="text-lg font-bold mb-2 mt-6"
                      style={{ color: '#F5F5F5' }}
                    >
                      {processMathInText(String(children))}
                    </h3>
                ...
                blockquote({ children }) {
                  return (
                    <blockquote
                      className="border-r-4 pr-4 my-6 italic"
                      style={{
                        borderColor: '#1C39BB60',
                        color: '#B0B0B0',
                      }}
                    >
                      {children}
